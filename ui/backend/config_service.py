...
def build_segmentation_field_catalog() -> List[ConfigField]:
    ...
    return [
        ...
        ConfigField(
            ...
            field_type="number",
            description="Number of upcoming tokens exposed to the scorer when evaluating transitions.",
            advanced=True,
        ),
        ConfigField(
            ...
            field_type="boolean",
            description="Run forward and backward beam searches and keep higher-scoring boundaries from each.",
            advanced=True,
        ),
        ConfigField(
            ...
            field_type="boolean",
            description="Revisit low-scoring blocks with a wider beam to merge awkward single-word cues before reflow.",
            advanced=True,
        ),
        ConfigField(
            path=["enable_reflow"],
            ...
            field_type="boolean",
            description="Reflow short or imbalanced cues after segmentation without merging across speaker changes.",
            advanced=True,
        ),
        ConfigField(
