...
def build_segmentation_field_catalog() -> List[ConfigField]:
    ...
    return [
        ...
        ConfigField(
            ...
            field_type="boolean",
            description="Run a reverse-informed pass to revisit disputed transitions.",
        ),
        ConfigField(
            ...
            field_type="number",
            description="Number of future tokens exposed to the transition scorer.",
        ),
        ConfigField(
            ...
            field_type="boolean",
            description="Re-run low scoring windows with a wider beam to smooth breaks.",
        ),
        ConfigField(
            path=["enable_reflow"],
            section="Post-processing",
            ...
            field_type="boolean",
            description="Merge or rebalance awkward cues after the main beam search.",
        ),
        ConfigField(
        ...
        ConfigField(
            ...
            section="Constraints",
            label="Min projected second line length",
            field_type="number",
            description="Discourage manual breaks when the next line would be shorter than this many characters.",
            advanced=True,
        ),
        ConfigField(
            ...
            field_type="number",
            description="Avoid inserting line breaks after dangling particles or very short words.",
            advanced=True,
        ),
        ConfigField(
            path=["constraints", "min_block_length_char"],
            section="Constraints",
            label="Baseline block character minimum",
            field_type="number",
            description="Applies a gentle penalty when cues fall below this total character count.",
            advanced=True,
        ),
        ConfigField(
            path=["constraints", "min_line_length_char"],
            section="Constraints",
            label="Baseline line character minimum",
            field_type="number",
            description="Penalises individual lines shorter than this threshold even when sliders are neutral.",
            advanced=True,
        ),
        ConfigField(
        ...
        ConfigField(
            path=["sliders", "fallback_sb_penalty"],
            section="Stylistic sliders",
            label="Fallback SB penalty",
            field_type="number",
            description="Penalty applied when the search is forced to close a block.",
            advanced=True,
        ),
        ConfigField(
