...
- Docs: `docs/BASELINE.md`, `docs/SECURITY_NOTES.md`, `docs/beam_search_walkthrough.md`, `docs/build_training_pair_comparison.md`, `docs/spacy_feature_impact.md`, `experiments/alt_build_training_pair_standalone.py`.
...
- Scripts: `legacy/dev_console.sh`, `scripts/evaluate_model.py`, `scripts/install.py`, `scripts/train_model.py`, `scripts/__init__.py`.
